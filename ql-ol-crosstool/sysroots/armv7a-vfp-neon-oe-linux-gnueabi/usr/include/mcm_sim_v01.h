...
typedef enum {
  ...
  MCM_SIM_APDU_RETURN_PROCEDURE_BYTES_V01_V01 = 0x00, /**<   Return intermediate procedure bytes (Default)\n   */
  MCM_SIM_APDU_SKIP_PROCEDURE_BYTES_V01_V01 = 0x01, /**<   Return final result and status words   */
