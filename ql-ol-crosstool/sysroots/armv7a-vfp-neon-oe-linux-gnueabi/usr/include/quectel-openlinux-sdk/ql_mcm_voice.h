...
/*=================================================================
  ...
  12/03/2019       Rambo       add ecall state
  03/20/2019       Rambo       add ecall timer set
  03/29/2019       Rambo       Added ecall value for era_glonass.
  07/26/2019       Rambo       Added eCall automatic answer api. 
  =================================================================*/
...
typedef enum
{
  ...
  E_QL_MCM_VOICE_ECALL_CONFIG_CLEARDOWN_TIMER   ,
  E_QL_MCM_VOICE_ECALL_CONFIG_INITIATION_TIMER  ,
  E_QL_MCM_VOICE_ECALL_CONFIG_NAD_REGISTRATION_TIMER  ,
  E_QL_MCM_VOICE_ECALL_CONFIG_NAD_UNREGISTRATION_TIMER, 
  E_QL_MCM_VOICE_ECALL_CONFIG_ECALL_SYSTEM      ,
  E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_REDIAL_TIMER,
  E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_AUTO_ANSWER_TIMER
...
typedef struct 
{
  ...
  uint8_t dropredial;
  uint16_t T2;              /*  The timer of IVS waiting for "ClearDown".*/
  uint16_t T3;              /*  The timer of IVS waiting for "InitIATION".*/
  uint16_t T9;              /*  The timer of IVS waiting for "NAD Registration".*/
  uint16_t T10;             /*  The timer of IVS waiting for "NAD Deregistration".*/
  uint8_t ecall_system;     /*  The ecall system standard.  0 -- EU; 1 -- ERA_GLONASS*/
  uint16_t era_glonass_redial_time;     /*  The timer of era_glonass redial times.*/
  uint16_t era_glonass_auto_answer_time;/*  The timer of era_glonass auto answer times.*/
...
typedef enum {
  MCM_VOICE_ECALL_EVENT_ECALL_START_RECEIVED_SYNCHRONIZATION = 0, /**<  eCall start recevied synchronization. */
  MCM_VOICE_ECALL_EVENT_T9_TIMEOUT  = 1, /**<  eCall T9 TIMEOUT. */
  MCM_VOICE_ECALL_EVENT_T10_TIMEOUT = 2, /**<  eCall T10 TIMEOUT. */
  MCM_VOICE_ECALL_EVENT_PROCESS_IVS_AlACK_RECEIVED = 3, /**<  eCall AlACK_RECEIVED. */
}E_QL_MCM_VOICE_ECALL_EVENT_EXTEND_STATE_T;
...
typedef struct 
{
  ...
  uint8_t                                               ecall_event_extend_state_valid; 
  E_QL_MCM_VOICE_ECALL_EVENT_EXTEND_STATE_T             ecall_event_extend_state;     /**<   event of eCall extend state.*/
  //--------------added end
