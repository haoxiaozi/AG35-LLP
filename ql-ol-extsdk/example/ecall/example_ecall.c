                                   ...
                                   uint32_t ind_data_len)
{
    ...
    */
    case E_QL_MCM_VOICE_ECALL_EVENT_IND:
    {
        ...
        //added by [Rambo] 2019/03/12 -- for ecall state 
        if(pEcallEventInd->ecall_event_extend_state_valid)
        {
            printf("========== Ecall IND EVENT:   ecall_event_extend_state:%d ==========  \r\n", pEcallEventInd->ecall_event_extend_state);
        }
        //--------------added end
        break;
    }
...
int main(int argc, char *argv[])
{
    ...
    case 5://QL_Voice_Call_Ecall_GetConfigInfo
        ...
        ql_mcm_ecall_config_info ecall_config = {0,};
            ...
            printf("enable:%d, voiceconfig:%d, ecallmode:%d, processinfo:%d,",
                    ecall_config.enable,
                    ecall_config.voiceconfig,
                    ecall_config.ecallmode,
                    ecall_config.processinfo);
            printf("T5:%d, T6:%d, T7:%d, mofailredial:%d, dropredial:%d,",
                    ecall_config.T5,
                    ecall_config.T6,
                    ecall_config.T7,
                    ecall_config.mofailredial,
                    ecall_config.dropredial);
            printf("T2:%d, T3:%d, T9:%d, T10:%d, system:%d, redial_time:%d, era_glonass_auto_answer_time:%d",
                    ecall_config.T2,
                    ecall_config.T3,
                    ecall_config.T9,
                    ecall_config.T10,
                    ecall_config.ecall_system,
                    ecall_config.era_glonass_redial_time,
                    ecall_config.era_glonass_auto_answer_time);
            break;
        }
    ...
    case 6://QL_Voice_Call_Ecall_SetConfigInfo
        ...
        printf("ecall config type(9-E_QL_MCM_VOICE_ECALL_CONFIG_CLEARDOWN_TIMER): \n");
        printf("ecall config type(10-E_QL_MCM_VOICE_ECALL_CONFIG_INITIATION_TIMER): \n");
        printf("ecall config type(11-E_QL_MCM_VOICE_ECALL_CONFIG_NAD_REGISTRATION_TIMER): \n");
        printf("ecall config type(12-E_QL_MCM_VOICE_ECALL_CONFIG_NAD_UNREGISTRATION_TIMER): \n");
        printf("ecall config type(13-E_QL_MCM_VOICE_ECALL_CONFIG_ECALL_SYSTEM): \n");
        printf("ecall config type(14-E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_REDIAL_TIMER): \n");
        printf("ecall config type(15-E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_AUTO_ANSWER_TIMER): \n");
        ...
        switch(ecall_config_type)
        {
            ...
            case 8:
                ...
                break;
            case 9:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_CLEARDOWN_TIMER,value);
                break;
            case 10:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_INITIATION_TIMER,value);
                break;
            case 11:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_NAD_REGISTRATION_TIMER,value);
                break;
            case 12:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_NAD_UNREGISTRATION_TIMER,value);
                break;
            case 13:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_ECALL_SYSTEM,value);
                break;
            case 14:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_REDIAL_TIMER,value);
                break;
            case 15:
                ret = QL_Voice_Call_Ecall_SetConfigInfo(h_voice,E_QL_MCM_VOICE_ECALL_CONFIG_ERA_GLONASS_AUTO_ANSWER_TIMER,value);
                break;
            default:
    ...
    case 7://QL_Set_EcallSysStd
       {
            ...
            printf(" QL_Set_EcallSysStd not support");
            break;
       }
    ...
    case 8://QL_Set_MsdVersion
       {
           ...
           printf(" QL_SET_version is not surport.\n");
    ...
    case 9://QL_Set_MsdMessageData
       {
           printf(" QL_Set_MsdMessageData not support");
           break;
       }
    ...
    case 11://QL_Msd_Encode
       {
           printf(" QL_Msd_Encode not support");
