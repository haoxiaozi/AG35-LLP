...
static int pin_value = 0; /*BT_HOST_WAKE Pin Value*/
    ...
    || defined(__QUECTEL_PROJECT_AG35CEN__)|| defined(__QUECTEL_PROJECT_AG35CEVBM__) || defined(__QUECTEL_PROJECT_AG35NA__)|| defined(__QUECTEL_PROJECT_AG35J__)\
|| defined(__QUECTEL_PROJECT_AG35LA__)
