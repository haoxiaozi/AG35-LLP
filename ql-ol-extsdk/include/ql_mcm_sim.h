...
#define QL_SIM_AID_MAX              32      /**< Maximum number of application identifier. */
#define QL_SIM_APDU_DATA_MAX        1024    /**< Maximum number of APDU data. */
#define QL_SIM_SELECT_RESPONSE_MAX  255     /**< Maximum number of select response. */
...
}QL_MCM_SIM_CARD_RESULT_T;

typedef struct 
{
    uint8_t                        channel_id_valid;
    uint8_t                        channel_id;
    QL_MCM_SIM_CARD_RESULT_T       card_result;
    ...
    uint8_t                        select_response[QL_SIM_SELECT_RESPONSE_MAX];
}QL_MCM_SIM_LOGICAL_CHANNEL_T;

typedef struct
{
    uint32_t   aid_len;
    uint8_t    aid[QL_SIM_AID_MAX];
}QL_MCM_SIM_AID_INFO_T;  

typedef struct
{
    uint32_t  apdu_len;
    uint8_t   apdu[QL_SIM_APDU_DATA_MAX];
    uint8_t   channel_id;
}QL_MCM_SIM_SEND_APDU_T;  
...
}QL_MCM_SIM_SEND_APDU_LONG_RESPONSE_T;  /* Type */
...
}QL_MCM_SIM_SEND_APDU_LONG_RESPONSE_CHUNK_T;
...
typedef struct
 {
  ...
  QL_MCM_SIM_SEND_APDU_LONG_RESPONSE_CHUNK_T long_response;
}QL_MCM_SIM_SEND_APDU_RESPONSE_T;
...
/*===========================================================================
  ...
  FUNCTION:  QL_MCM_SIM_OpenLogicalChannel

===========================================================================*/
/*
    @brief
    Function opens a logical channel on a UICC card.

    @return
    E_QL_ERROR_CODE_T
*/
/*=========================================================================*/
E_QL_ERROR_CODE_T QL_MCM_SIM_OpenLogicalChannel
(
    sim_client_handle_type          h_sim,
    E_QL_MCM_SIM_SLOT_ID_TYPE_T     slot_id,    ///< [IN] slot id
    QL_MCM_SIM_AID_INFO_T           *pt_info,   ///< [IN] application identifier
    QL_MCM_SIM_LOGICAL_CHANNEL_T    *pt_out     ///< [OUT] response
);

/*===========================================================================

  FUNCTION:  QL_MCM_SIM_CloseLogicalChannel

===========================================================================*/
/*
    @brief
    Function close a logical channel on a UICC card.

    @return
    E_QL_ERROR_CODE_T
*/
/*=========================================================================*/
E_QL_ERROR_CODE_T QL_MCM_SIM_CloseLogicalChannel
(
    sim_client_handle_type          h_sim,
    E_QL_MCM_SIM_SLOT_ID_TYPE_T     slot_id,    ///< [IN] slot id
    uint8_t                         channel_id ///< [IN] channel id
);

/*===========================================================================

  FUNCTION:  QL_MCM_SIM_SendApdu

===========================================================================*/
/*
    @brief
    Function sends an APDU to the card.

    @return
    E_QL_ERROR_CODE_T
*/
/*=========================================================================*/
E_QL_ERROR_CODE_T QL_MCM_SIM_SendApdu
(
    sim_client_handle_type  h_sim,
    E_QL_MCM_SIM_SLOT_ID_TYPE_T     slot_id,    ///< [IN] slot id
    QL_MCM_SIM_SEND_APDU_T  *pt_apdu, ///< [IN] apdu to send
    QL_MCM_SIM_SEND_APDU_RESPONSE_T *pt_apdu_resp   ///< [OUT] apdu response
);
