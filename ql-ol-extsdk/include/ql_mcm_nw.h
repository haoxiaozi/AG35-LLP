...
/** add by stan.li@20190718 start: for geting cell information */
...
typedef struct 
{
    ...
    QL_MCM_NW_CDMA_INFO_T   cdma_info;                              /**<  CDMA cell information (Serving). */  
